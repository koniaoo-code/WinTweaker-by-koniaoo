...
public sealed class Strings
{
    ...
    private static readonly Strings Ru = new(new()
    {
        ...
        ["restart_explorer"] = "🔄  Проводник",
        ["restart_explorer_done"] = "Проводник перезапущен ✓",
        ["settings_about"] = "⚙  Настройки",
        ["enable"] = "Вкл",
        ["disable"] = "Выкл",
        ...
        ["reboot_btn"] = "⚠️  Перезагрузка",
        ["reboot_tip"] = "Некоторые твики требуют перезагрузки ПК для вступления в силу",
        ["restart_exp_tip"] = "Перезапустить explorer.exe для применения изменений интерфейса",
        ["settings_tip"] = "Настройки, выбор языка/темы и информация о программе",
        ["log_tip"] = "Открыть или скрыть консоль журнала операций",
        ...
        ["dash_status_great"] = "✓  Отличное состояние",
        ["dash_status_good"] = "●  Стабильная работа",
        ["dash_status_warn"] = "⚠  Требуется оптимизация",
        ["dash_subtitle"] = "Мониторинг ресурсов и статус системы в реальном времени",
        ["dash_metrics"] = "Параметры системы",
        ["dash_ram"] = "ОЗУ",
        ...
        ["qa_cs2"] = "🎯  Применить «CS2 Esports» (Низкий Input Lag)",
        ["qa_shaders"] = "🎮  Очистить кэш шейдеров (DirectX, NVIDIA, AMD)",
        ["shaders_cleared"] = "Кэш шейдеров очищен ✓",
        ...
        ["whatsnew_title"] = "Что нового в WinTweaker 2.1",
        ["whatsnew_ok"] = "Отлично!",
        ["whatsnew_body"] =
            "Дизайн Material You (M3): стиль Google с пастельной палитрой, анимированными тумблерами (16px → 24px) и кнопками-пилюлями\n" +
            "CS2 & Низкий Input Lag: постоянный приоритет cs2.exe в IFEO, отключение Dynamic Tick в BCD и службы GameBarPresenceWriter\n" +
            "Пресет «CS2 Esports»: соревновательный профиль настроек для ровного фреймтайма и минимальной задержки в один клик\n" +
            "Очистка кэша шейдеров: быстрое удаление кэшей DirectX, NVIDIA и AMD от микрофризов после апдейтов игры или драйверов\n" +
            "UWP вырезается навсегда: удаление через ProvisionedPackage блокирует самопроизвольный возврат софта после обновлений Windows\n" +
            "Фикс Проводника: экран больше не мигает по 10 раз — оболочка перезапускается строго один раз в самом конце",
    ...
    private static readonly Strings En = new(new()
    {
        ...
        ["reboot_btn"] = "⚠️  Restart",
        ["reboot_tip"] = "Some tweaks require a system restart to take full effect",
        ["restart_exp_tip"] = "Restart explorer.exe to apply interface and shell changes",
        ["settings_tip"] = "Settings, language/theme options, and about WinTweaker",
        ["log_tip"] = "Toggle the operation log console",
        ...
        ["dash_status_great"] = "✓  Excellent condition",
        ["dash_status_good"] = "●  Stable performance",
        ["dash_status_warn"] = "⚠  Optimization recommended",
        ["dash_subtitle"] = "Real-time system resource monitoring and status",
        ["dash_metrics"] = "System Metrics",
        ["dash_ram"] = "RAM",
        ["dash_disk"] = "Free on C:",
        ["dash_proc"] = "Processes",
        ...
        ["qa_cs2"] = "🎯  Apply «CS2 Esports» (Low Input Lag)",
        ["qa_shaders"] = "🎮  Clear Shader Cache (DirectX, NVIDIA, AMD)",
        ["shaders_cleared"] = "Shader cache cleared ✓",
        ...
        ["whatsnew_title"] = "What's new in WinTweaker 2.1",
        ["whatsnew_ok"] = "Awesome!",
        ["whatsnew_body"] =
            "Material You (M3) Design: Google style with pastel palette, animated switches (16px → 24px), and pill buttons\n" +
            "CS2 & Low Input Lag: permanent high priority for cs2.exe in IFEO, disabled BCD Dynamic Tick and GameBarPresenceWriter\n" +
            "«CS2 Esports» Preset: one-click competitive profile for maximum FPS consistency and lowest input lag\n" +
            "Shader Cache Cleaner: deletes DirectX, NVIDIA, and AMD shader caches to fix micro-stutters after game/driver updates\n" +
            "UWP Removed Forever: ProvisionedPackage removal prevents apps from reappearing after Windows Updates\n" +
            "Explorer Restart Fix: no more repeated screen flickering — the shell restarts strictly once at the end",
